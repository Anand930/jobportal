...
const UpdateProfileDialog = ({ open, setOpen }) => {
    ...
    const submitHandler = async(e)=>{
        ...
        try {
            const res = await axios.post(`${USER_API_VARIABLE}/profile/update`,formData,{
                headers:{
    ...
    return (
        <div>
            <Dialog open={open}>
                <DialogContent className={"sm:max-w-[426px]"} onInteractOutside={() => setOpen(false)}>
                    <DialogHeader>
                        <DialogTitle>
                            Update Profile
                        </DialogTitle>
                        ...
                        <DialogFooter>
                            {
                                ...
                                </Button> : <Button className={"w-full my-4"}>Update</Button>
                            }
                        </DialogFooter>
                    </form>
                </DialogContent>
